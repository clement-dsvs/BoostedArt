...
<div id="logMenuAcceuil">
    <ul>
        <li><div id="logMenuAcceuil1"><a href="login.php">Se connecter</a></div></li>
        <li><div id="logMenuAcceuil2"><a href="signup.php">S'enregistrer</a></div></li>
    </ul>
</div>
